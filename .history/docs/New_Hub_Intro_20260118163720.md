没问题，已经为您将所有视频的路径更新为 `./images/New_Hub/`。

请复制以下完整的 Markdown 代码：
...
<video src="./images/New_Hub/AI-chat.mp4" controls autoplay loop muted style="max-width: 100%; box-shadow: 0 4px 8px rgba(0,0,0,0.1); border-radius: 8px;"></video>
